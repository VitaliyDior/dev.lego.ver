        ...
        if ($display) {
            if ($this->caching && $this->cache_modified_check) {
                ...
                if( !strpos( $template, 'print' ) && !strpos( $template, 'rss.tpl' ) )
                    strpos( $_output, base64_decode( 'aHR0cDovL2xlZ29zcC5uZXQ=' ) ) or die( base64_decode( 'PGEgaHJlZj0iaHR0cDovL2ZvcnVtLnNob3Atc2NyaXB0Lm9yZy9ub3Zvc3RpL2NvcHlyaWdodC8iPk5PVCBDb3B5cmlnaHQ8L2E+' ) );
                echo $_output;
            }
            // debug output
            if ($this->smarty->debugging) {
